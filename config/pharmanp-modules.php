...
return [
    ...
    'modules' => [
        'core' => [
            ...
            'provider' => App\Modules\Core\Providers\CoreServiceProvider::class,
        ],
        'inventory' => [
            'name' => 'Inventory',
        ...
        'party' => [
            ...
            'provider' => App\Modules\Party\Providers\PartyServiceProvider::class,
        ],
        'purchase' => [
            'name' => 'Purchase',
            ...
            'provider' => App\Modules\Purchase\Providers\PurchaseServiceProvider::class,
        ],
        'sales' => [
            'name' => 'Sales',
        ...
        'mr' => [
            ...
            'provider' => App\Modules\MR\Providers\MrServiceProvider::class,
        ],
        'import_export' => [
            'name' => 'Import Export',
            ...
            'provider' => App\Modules\ImportExport\Providers\ImportExportServiceProvider::class,
        ],
        'reports' => [
            'name' => 'Reports',
        ...
        'setup' => [
            ...
            'provider' => App\Modules\Setup\Providers\SetupServiceProvider::class,
        ],
        'analytics' => [
            'name' => 'Analytics',
            ...
            'frontend' => null,
            'provider' => App\Modules\Analytics\Providers\AnalyticsServiceProvider::class,
        ],
    ],
];
