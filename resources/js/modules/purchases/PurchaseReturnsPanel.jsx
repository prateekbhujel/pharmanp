...
import { App, Button, Card, DatePicker, Form, Input, InputNumber, Modal, Radio, Select, Space } from 'antd';
...
export function PurchaseReturnsPanel() {
    ...
    const listColumns = [
        ...
        { title: 'Date', dataIndex: 'return_date', field: 'return_date', sorter: true, width: 130 },
