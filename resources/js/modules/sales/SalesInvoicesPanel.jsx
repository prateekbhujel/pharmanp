        ...
        { title: 'Status', dataIndex: 'is_active', width: 110, render: (v) => <StatusBadge value={v} /> },
        {
            ...
            render: (_, row) => (
                <Space>
                    ...
                    <Button icon={<PrinterOutlined />} onClick={() => openDocumentDirectly(backendUrl(`/sales/invoices/${row.id}/print`))}>Print</Button>
                    <Button onClick={() => openDocumentDirectly(backendUrl(`/sales/invoices/${row.id}/pdf`), { accept: 'application/pdf' })}>PDF</Button>
                </Space>
            ),
        },
    ];
        ...
        <>
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button key="print" icon={<PrinterOutlined />} onClick={() => openDocumentDirectly(backendUrl(`/sales/invoices/${viewingInvoice?.id}/print`))}>Print</Button>,
