...
const SetupStructurePage = React.lazy(() => import('../../modules/settings/SetupStructurePage').then((module) => ({ default: module.SetupStructurePage })));
...
export const routes = {
    ...
    [appUrl('/app/purchases/expiry-returns')]: PurchasesPage,
    ...
    [appUrl('/app/sales/expiry-returns')]: SalesPage,
    ...
    [appUrl('/app/reports/expiry-buckets')]: ReportsPage,
    [appUrl('/app/reports/dumping')]: ReportsPage,
    ...
    [appUrl('/app/reports/supplier-aging')]: ReportsPage,
    [appUrl('/app/reports/customer-aging')]: ReportsPage,
    ...
    [appUrl('/app/reports/mr-vs-product')]: ReportsPage,
    [appUrl('/app/reports/mr-vs-division')]: ReportsPage,
    [appUrl('/app/reports/mr-vs-sales')]: ReportsPage,
    [appUrl('/app/reports/company-vs-customer')]: ReportsPage,
    [appUrl('/app/reports/target-achievement')]: ReportsPage,
    [appUrl('/app/administration/users')]: UsersPage,
    [appUrl('/app/administration/roles')]: RolesPage,
    [appUrl('/app/administration/employees')]: SetupStructurePage,
    [appUrl('/app/administration/branches')]: DataLookupPage,
    [appUrl('/app/administration/areas')]: SetupStructurePage,
    [appUrl('/app/administration/divisions')]: SetupStructurePage,
    [appUrl('/app/administration/targets')]: SetupStructurePage,
    [appUrl('/app/administration/payment-modes')]: DataLookupPage,
    [appUrl('/app/administration/party-types')]: DataLookupPage,
    [appUrl('/app/administration/supplier-types')]: DataLookupPage,
