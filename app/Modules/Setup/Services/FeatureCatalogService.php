...
class FeatureCatalogService
{
    ...
    public function defaults(): array
    {
        return [
            ...
            ['module' => 'MR', 'code' => 'mr.performance', 'name' => 'MR performance', 'description' => 'Targets, visits, invoice/order value, login access and area tracking.', 'status' => 'ready', 'is_billable' => true],
