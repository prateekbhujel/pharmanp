...
class FeatureCatalogService
{
    ...
    public function defaults(): array
    {
        return [
            ...
            ['module' => 'Accounting', 'code' => 'accounting.trial_balance', 'name' => 'Trial balance', 'description' => 'Balanced account summary with grouped debit, credit and closing side details.', 'status' => 'foundation', 'is_billable' => false],
            ...
            ['module' => 'MR', 'code' => 'mr.performance', 'name' => 'MR performance', 'description' => 'Targets, visits, invoice/order value, login access and territory tracking.', 'status' => 'foundation', 'is_billable' => true],
            ['module' => 'Setup', 'code' => 'setup.users', 'name' => 'Users and profile', 'description' => 'User CRUD, role assignment, MR-linked login and profile management.', 'status' => 'foundation', 'is_billable' => false],
